...
key_size_limit() ->
    % Convert stored key limit from KB to bytes
    config:get_integer("couch_views", "key_size_limit", 8) * 1000.


value_size_limit() ->
    % Convert stored value limit from KB to bytes
    config:get_integer("couch_views", "value_size_limit", 64) * 1000.
